...
Route.find_or_create_by(inicio: ciudad_1, destino: ciudad_2)
Route.find_or_create_by(inicio: ciudad_3, destino: ciudad_4)
Route.find_or_create_by(inicio: ciudad_5, destino: ciudad_6)
Route.find_or_create_by(inicio: ciudad_1, destino: ciudad_6)
Route.find_or_create_by(inicio: ciudad_2, destino: ciudad_5)
Route.find_or_create_by(inicio: ciudad_3, destino: ciudad_4)
Route.find_or_create_by(inicio: ciudad_3, destino: ciudad_6)
