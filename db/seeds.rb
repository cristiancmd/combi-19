...
user1 = User.create!  :name => 'John', :email => 'test@test.com', :password => 123456 , :password_confirmation => 123456, :dni => 37125636,date_of_birth: Date.parse("1990-03-05")
...
chofer1 = Chofer.create! :password => '123456', :email => 'jorge@jorge.com', :nombre => 'Jorge', :apellido => 'Perez', :dni => 33333, :inicio_actividad => "Date.parse('2000-04-2')"
chofer2 = Chofer.create! :password => '123456', :email => 'alberto@chofer.com',:nombre => 'Alberto', :apellido => 'Aninstein', :dni => 222222, :inicio_actividad => "Date.parse('1999-04-2')"
...
combi1 = Bus.find_or_create_by(asientos: 30, tipo:"Super-cómoda", patente:"ASD 123")
...
combi4 = Bus.find_or_create_by(asientos: 10 , tipo:"Super-cómoda", patente:"BBB 000")
...
Trip.find_or_create_by(horario: "2020-12-05 12:30:00", rate: 64456, chofer_id:chofer1.id, bus_id: combi4.id, route_id:ruta3.id)
Trip.find_or_create_by(horario: "2020-12-30 12:30:00", rate: 32133, chofer_id:chofer2.id, bus_id: combi4.id, route_id:ruta4.id)
Trip.find_or_create_by(horario: "2020-12-31 12:30:00", rate: 56132, chofer_id:chofer1.id, bus_id: combi4.id, route_id:ruta5.id)
